...
const SuspendCategoryModal = ({ categoryToRestore, handleRestore }) => {
  return (
            ...
            <div className="nk-modal">
              ...
              <div className="nk-modal-text">
                <div className="caption-text">
                  Are you sure you want to restore this category with ID <strong>{categoryToRestore}</strong>? This action cannot be undone.
                </div>
              </div>
